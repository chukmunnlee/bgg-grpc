...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.healthcheck.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthClient) Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, "/grpc.healthcheck.Health/Watch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.healthcheck.Health/Check",
	}
...
func _Health_Watch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.healthcheck.Health/Watch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Health_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.healthcheck.Health",
	...
	Metadata: "grpc/healthcheck/healthcheck.proto",
}
